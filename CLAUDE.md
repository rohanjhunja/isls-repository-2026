...
| `define-research-property` | `.agents/skills/define-research-property/SKILL.md` | Author typed property definitions in `data/properties/*.yaml` |
...
- **Immutable Source Seed**: `data/derived/ground_truth_registry.json` is the 10-year golden dataset. `proceedings.db` can be recomputed at any time in ~8s without loss.
